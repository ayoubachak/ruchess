...
class SocketService {
  ...
  connect(roomId: string): void {
    ...
    this.socket.on('game-state', (data: any) => this.triggerCallbacks('game-state', data));
    this.socket.on('player-joined', (data: any) => this.triggerCallbacks('player-joined', data));
    this.socket.on('game-start', (data: any) => this.triggerCallbacks('game-start', data));
    this.socket.on('opponent-move', (data: any) => this.triggerCallbacks('opponent-move', data));
  ...
  async createRoom(): Promise<string> {
    try {
      const response = await fetch(`${this.serverUrl}/create-game`);
